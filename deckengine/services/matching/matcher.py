...
from deckengine.services.matching import personas      # buyer-role detection + persona-relevance scoring
from deckengine.services.content import case_library  # content-store case studies (the new source of case picks)
from deckengine.services.matching import relevance     # content + semantic ranking of cases (no hard filters)
from deckengine.services.matching.tagger import FUNCTION as _FUNCTION_MAP, _score as _fn_score
