...
from deckengine.services.matching import personas  # derive which buyer-role(s) a slide speaks to
...
if __name__ == "__main__":
    import json
    import sys
    src = sys.argv[1] if len(sys.argv) > 1 else config.LIBRARY_JSON
    out = sys.argv[2] if len(sys.argv) > 2 else config.TAGGED_LIBRARY_JSON
