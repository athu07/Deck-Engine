...
# ── F2: "Re-skin a deck" -- restyle an uploaded deck's shapes in place into the J2W design.
#    Re-enabled (owner's spec, 2026-07-14) for testing alongside Recreate-with-AI. reskin.py
#    is also used by Recreate for its restyle fallback + PNG renderer.
