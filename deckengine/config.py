...
# PRE-RENDERED master-deck slide previews, generated by scripts/prerender_master.py and
# COMMITTED. The review page shows these; without them a server with no LibreOffice (a
# plain Render web service, say) can render nothing, and one WITH LibreOffice pays a
