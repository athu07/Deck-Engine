...
from deckengine.services.content import build_library as bl

DECK = config.MASTER_DECK
XLSX = config.CASE_STUDIES_SOURCE_XLSX      # the source of truth we keep complete
XLSX_OUT = config.CASE_STUDIES_SOURCE_XLSX  # overwrite in place when --write
